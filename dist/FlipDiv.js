...
(function(root, factory) {
    ...
    var FlipDiv = {
        // store all the FlipDiv when they're initialized
        _FlipDivs: [],
                ...
                return (function() {
                    ...
                    function setupWrapper() {
                        ...
                        ['left', 'right', 'top', 'bottom'].forEach(function(pos) {
                            FlipDiv.removeClass(dom.wrapper, 'flipDiv-' + pos);
                        });
                    ...
                    function setupMenu(starting) {
                        ...
                        if (supports3DTransforms) {
                            ...
                            style[FlipDiv.prefix('transition')] = FlipDiv.lcPrefix('transform') + ' ' + config.transitionDuration + ' ' + config.transitionEasing;
                        } else {
                    ...
                    /**
                     * Close any other open flipDivs
                     */
                    function closeOtherFlipDivs() {
                        FlipDiv._FlipDivs.forEach(function(flipD) {
                            flipD.close(dom.menu);
                        });
                    }
                    /**
                     * Expands the menu.
                    ...
                    FlipDiv._FlipDivs.push(thisFlipDiv);
                    return thisFlipDiv;
                })()
            }
            /**
